<p align="center">
<img src="HDR logo.png" width="180">
</p>
...
The project provided an opportunity to apply classroom knowledge of fluid mechanics and mechanical systems to a real-world building design environment. I worked within the Revit model to develop HVAC layouts while considering architectural constraints and coordination with other building disciplines.
...
My work supported the development of an HVAC layout that balanced several considerations:

- Appropriate supply and return air distribution
- Accurate duct sizing based on design requirements
- Efficient ductwork routing through available spaces
- Coordination with architectural and structural elements
- Clear and consistent mechanical documentation
- Accurate tagging and identification of HVAC components

The challenge was to develop a mechanical system that was both technically appropriate and practical to coordinate within the overall building design.
